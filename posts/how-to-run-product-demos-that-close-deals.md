...
1. **The specific problem they are trying to solve.** Not the general category ("we need better project management") but the actual pain ("our team misses deadlines because task dependencies are invisible and blockers surface too late"). Record the prospect's exact words. You will use them during the demo.

2. **Their current solution and its shortcomings.** Understanding what they use today tells you what they are comfortable with and what gaps to emphasize. If they currently use spreadsheets, your demo should highlight automation. If they use a competitor, your demo should highlight differentiators.

3. **Who will be in the room.** A demo for the end-user focuses on usability and workflow fit. A demo for a VP focuses on reporting, ROI, and team-wide impact. A demo for a CTO focuses on integrations, security, and technical architecture. Knowing the audience determines the storyline.

4. **Their decision timeline and process.** "We need to decide by end of quarter" dictates a different demo pace than "we are just exploring options." If there is urgency, emphasize speed of implementation and quick time-to-value. If they are early in the process, invest more in building the vision.
...
At The Proper Motion Company, we build software products designed to demo well and sell themselves. If you are building a product and want to ensure it tells a compelling story from the first click, [let us work together](/contact.html).
